...
import { Button, Dialog, DialogTitle, DialogContent, DialogActions, IconButton, Icon, AppBar, Tabs, Tab, Typography, Select, MenuItem } from '@material-ui/core';
...
class CreateAssetModal extends Component {
  ...
  submit = (asset) => {
    ...
    const params = this.state.createAssetMode === CREATE_ASSET_MODES.USING_FIELDS ? {
      sku: asset.sku,
        ...
        >
          <Form onSubmit={handleSubmit(this.submit)}>
            ...
            <DialogContent>
              ...
              >
                <MenuItem value={CREATE_ASSET_MODES.USING_FIELDS}>Using fields</MenuItem>
                <MenuItem value={CREATE_ASSET_MODES.USING_CSV}>Using CSV file</MenuItem>
              </Select>
              {createAssetMode === CREATE_ASSET_MODES.USING_FIELDS ?
                <div><Field
                  name="sku"
            ...
            <DialogActions>
              ...
              <Button type="submit" color="primary"> {createAssetMode === CREATE_ASSET_MODES.USING_FIELDS ? 'Create' : 'Import'} </Button>
            </DialogActions>
          </Form>
        </Dialog>
      </div >
